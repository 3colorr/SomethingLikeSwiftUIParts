...
extension View {
     ...
     */
    public func likeAccordion(isPresent: Binding<Bool>, body: View, closedImage: Image = Image(systemName: "chevron.up"), openedImage: Image = Image(systemName: "chevron.down")) -> some View {
